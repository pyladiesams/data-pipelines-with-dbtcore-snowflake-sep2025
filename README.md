...
### Presentation: [Building Data Pipelines with dbt Core and Snowflake](workshop/presentation.pdf)
...
## Data Sources
The data sources for this workshop are stored in the `workshop/datasources` folder. During setup, you'll load these files into your Snowflake instance following the instructions in the [workshop setup guide](workshop/workshop_setup.md).
...
## Usage
Run the following code to clone this repo to your computer:
```bash
...
## Pre-workshop Setup
Before attending the workshop, please follow the setup instructions in the [workshop_setup.md](workshop/workshop_setup.md) file, including:
...
## Video record
Re-watch [this YouTube stream](linkTBA)
